  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        {id: 1, user_name: 'Cate' , display_name: 'Catree' ,img:'https://tinyurl.com/ybmze666' , hash: '213123' },
        {id: 2, user_name: 'Ross' , display_name: 'MadDog' ,img:'https://tinyurl.com/ybmze666' , hash: '647467' },
