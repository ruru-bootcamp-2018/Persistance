...
const StatusBar = props => {
    ...
    const noms =
        props.currentGame.missions[mission_num - 1].rounds[round_num - 1]
            .nominations;
    ...
    switch (gameStage) {
        ...
        default:
            displayText =
                '404 this is not the page you were looking for - game stage not correctly defined';
    }
