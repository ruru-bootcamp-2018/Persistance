            ...
            <div className="modal is-active is-dark has-text-centered">
                ...
                <div className="modal-card">
                    <header className="modal-card-head modal-color">
                        <p className="modal-card-title has-text-white is-size-1">
                            This is the hammer round!
                        </p>
                        <button
                            className="delete"
                    ...
                    <section className="modal-card-body modal-color">
                        <div className="has-text-centered is-size-5 columns is-multiline modal-color">
                            <p>
                                {' '}
                                This round, the vote track has hit five, and{' '}
                                {this.props.hammer.display_name} who is the
                                hammer is the leader. If this team does not go
                                on the mission, the spies will win this round.
                                Vote carefully!
                            </p>
                        </div>
                    </section>
