...
class Intentions extends React.Component {
    ...
    render() {
        const intentions = this.props.currentGame.missions
            .slice()
            .reverse()
            .find(x => x.intentions.length > 0).intentions;
            ...
            <div className="modal is-active">
                ...
                <div className="modal-card">
                    ...
                    <section className="modal-card-body">
                        {intentions.map((x, i) => {
                            return (
                                <p key={i} className="is-size-3 has-text-black">
                                    {x.intention ? 'SUCCEED' : 'FAIL'}
                                </p>
                            );
                        })}
                    </section>
